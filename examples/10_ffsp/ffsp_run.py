# 10 - Build a small/fast FFSP stochastic finite-fault source and run it.
# 2026-06-06
...
# Small & fast: 16x8 subfaults, single realization (id_ran1=id_ran2=1), fixed seeds.
source = FFSPSource(
...
# FFSPSource.run() invokes the Fortran kernel (slow); written so it WOULD run.
subfaults = source.run()

assert subfaults is not None
print("PASS")

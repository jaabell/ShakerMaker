...
c***************************************************************
      ...
      subroutine layerParameter(k,lay,mb,stype,src,rcv,updn,ka,kb,d,rho,mu,xi,si,kd,mu2,exa,exb,ra,rb,Ca,Cb,Ya,Xa,Yb,Xb,r,r1,y,y1)
c***************************************************************
...
c***************************************************************
      ...
      subroutine haskellMatrix(a,kd,mu2,exa,exb,ra,rb,Ca,Cb,Ya,Xa,Yb,Xb,r,r1,y,y1)
c***************************************************************
...
c sh, the Haskell matrix is not needed. it is replaced by exb
      ...
      subroutine compoundMatrix(a,kd,mu2,exa,exb,ra,rb,Ca,Cb,Ya,Xa,Yb,Xb,r,r1,y,y1)
c***************************************************************
...
c sh, scaled by exb
      ...
      subroutine eVector(e,kd,mu2,exa,exb,ra,rb,Ca,Cb,Ya,Xa,Yb,Xb,r,r1,y,y1)
c***************************************************************
...
c sh part
      ...
      subroutine initialG(g,kd,mu2,exa,exb,ra,rb,Ca,Cb,Ya,Xa,Yb,Xb,r,r1,y,y1)
c***************************************************************
